...
fun bisectorByPoints(a: Point, b: Point): Line {
    ...
    val angleAngle = lineByPoints(a, b).angle + Math.PI / 2
    return if (angleAngle >= Math.PI) Line(middle, lineByPoints(a, b).angle - Math.PI / 2)
    else Line(middle, angleAngle)
}
